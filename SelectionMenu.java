...
/**
 * Write a description of class SelectionMenu here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SelectionMenu extends World
{
    ...
    /**
     * Constructor for objects of class SelectionMenu.
     * 
     */
    ...
    {    
        ...
        actor1.setImage(new GreenfootImage("Player 1, select your Pokémon!", 35, Color.BLACK, new Color(255,255,255, 185)));
    ...
    /**
     * sets the player2 selection world after player1 make selection
     */
    public void player2()
    {
        Greenfoot.setWorld(new SelectionMenu2());
    }
}
